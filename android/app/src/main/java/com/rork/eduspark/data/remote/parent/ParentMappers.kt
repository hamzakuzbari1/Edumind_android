...
internal fun ParentDashboardDto.toDomain(
    ...
    attendancePercentage = attendance.int("attendance_percentage"),
    streakDays = attendance.int("streak_days"),
    completedSessions = attendance.int("completed_sessions"),
    missedSessions = attendance.int("missed_sessions"),
