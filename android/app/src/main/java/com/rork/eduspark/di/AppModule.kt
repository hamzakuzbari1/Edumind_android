...
val appModule = module {
    ...
    // PR-01/PR-02/PR-03/PR-07/PR-10/PR-13 — Parent account, dashboard, performance, planner, subjects and student linking. Frontend-only mock state; no backend/API work.
