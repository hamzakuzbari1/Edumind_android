"""Row-level locking for listening progression mutations (PR-C)."""
...
async def lock_listening_progression_row(
    db: AsyncSession,
    *,
    student_id: int,
    language_id: int,
) -> LanguageProgression | None:
    """Acquire an exclusive row lock for promotion test submit / official promote."""
